...
import { Wrench, Zap, MessageSquare, Plus, Trash2, Info } from "lucide-react"
...
export function ToolConfig({ modelConfig, onUpdate }: ToolConfigProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg">高级工具调用设置</CardTitle>
          <CardDescription>并行工具调用和上下文注入等高级设置</CardDescription>
        </CardHeader>
